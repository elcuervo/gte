...
GTE_E5_AVAILABLE = !(e5_dir && File.exist?(File.join(e5_dir, 'tokenizer.json'))).freeze.nil?
GTE_EMBEDDING_DIM = ENV.fetch('GTE_EMBEDDING_DIM', '384').to_i

GTE_SIGLIP2_DIR = siglip2_dir.freeze
GTE_SIGLIP2_AVAILABLE = !(siglip2_dir && File.exist?(File.join(siglip2_dir, 'tokenizer.json'))).freeze.nil?
